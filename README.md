...
<!--justify-content-->These is used to distribute the space between the items.
<!--align-items-->These attribute is used to align the test and set to centre position.
<!--padding-->These is used to set the thickness of the area.
<!--color-->The color of the welcome text is set to black.
